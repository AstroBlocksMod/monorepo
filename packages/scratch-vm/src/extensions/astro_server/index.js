...
/**
 * astro: Blocks to provide the front-end for AstroBlocks server support.
 * @constructor
 */
class Server {
    constructor (runtime) {
            ...
            blocks: [
                {
                    ...
                    text: formatMessage({
                        id: 'astro_server.blocks.whenPageIsRequested',
                ...
                },
                {
                    ...
                    text: formatMessage({
                        id: 'astro_server.blocks.whenPageIsNotFound',
                ...
                '---',
                {
                    ...
                    text: formatMessage({
                        id: 'astro_server.blocks.returnContent',
                        // eslint-disable-next-line max-len
                    ...
                    arguments: {
                        CONTENT: {
                            type: ArgumentType.STRING,
                            defaultValue: 'Hello AstroBlocks!'
                        },
                        MIME: {
                            type: ArgumentType.STRING,
                ...
                },
                {
                    ...
                    text: formatMessage({
                        id: 'astro_server.blocks.returnRequest',
                ...
                },
                {
                    opcode: 'setMime',
                    text: formatMessage({
                        id: 'astro_server.blocks.setMime',
                ...
                },
                {
                    opcode: 'setStatus',
                    text: formatMessage({
                        id: 'astro_server.blocks.setStatus',
                ...
                },
                {
                    opcode: 'setHeaders',
                    text: formatMessage({
                        id: 'astro_server.blocks.setHeaders',
                ...
                },
                {
                    opcode: 'ipAddress',
                    text: formatMessage({
                        id: 'astro_server.blocks.ipAddress',
                        default: 'ip address',
                ...
                },
                {
                    opcode: 'headers',
                    text: formatMessage({
                        id: 'astro_server.blocks.headers',
                ...
                '---',
                {
                    opcode: 'checkMethod',
                    text: formatMessage({
                        id: 'astro_server.blocks.checkMethod',
                ...
                '---',
                {
                    opcode: 'readFile',
                    text: formatMessage({
                        id: 'astro_server.blocks.readFile',
                ...
                },
                {
                    opcode: 'writeFile',
                    text: formatMessage({
                        id: 'astro_server.blocks.writeFile',
                ...
                },
                {
                    ...
                    text: formatMessage({
                        id: 'astro_server.blocks.fileAccessStatus',
