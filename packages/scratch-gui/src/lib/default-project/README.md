`rocket.svg` is the Objective Scratch logo, scaled to 44% so it is a sensible sprite size.
It is the default project's costume and is also in the sprite library as "Objective Rocket".
